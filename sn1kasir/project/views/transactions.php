...
if (isset($_GET['view'])) {
    ...
    // Tambahkan auto print jika ada parameter print
...
<style>
    * {
    ...
    /* Tampilkan konten transaksi dan isinya */
    ...
    /* Sembunyikan tombol print di dalam konten */
    #transactionDetailsContent .form-group {
        display: none !important;
    }

    /* Bersihkan elemen tabel agar rapat dan sederhana */
    .table th, .table td {
...
<body>
    ...
    <div id="transactionDetailsContent" class="hidden-print-content">
        ...
        <div class="form-group">
            <button type="button" class="btn btn-success" onclick="window.print()">Print Struk Belanja</button>
        </div>
    </div>
    <?php endif; ?>
</body>
